    ...
    <div class="flex items-center justify-center pt-6 ">
        <table class="border-separate border border-slate-500 bg-white">
            <thead>
                ...
                <th class="border border-slate-600 px-4 py-4">Product name1</th>
                <th class="border border-slate-600 px-4 py-4">Product name2</th>
                <th class="border border-slate-600 px-4 py-4">Product name3</th>
            ...
            <?php 
				...
				<tr>
                    ...
                    <td class="border border-slate-600 px-4 py-4"> <img class="object-scale-down h-30 w-20" src="images/<?php echo $row['product_image2']; ?>"></td>
                    <td class="border border-slate-600 px-4 py-4"> <img class="object-scale-down h-30 w-20" src="images/<?php echo $row['product_image3']; ?>"></td>
                    ...
                    <td class="  px-4  py-10  mt-10 flex justify-center ">
                    <a href="editproduct.php?id=<?php echo $row['product_id']; ?>" class="px-2 py-2 leading-5 text-white bg-green-500 rounded-md focus:outline-none  mr-2">Edit</a>
					<a href="?delete=<?php echo $row['product_id']; ?>" class="px-2 py-2 leading-5 text-white bg-red-500 rounded-md  focus:outline-none">delete</a>
					</td>
				</tr>
				<?php 
						}
